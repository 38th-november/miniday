...
function Management() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: 'management-box', children: [_jsxs("div", { className: 'management-header', children: [_jsx("h3", { children: "\uD560 \uC77C" }), _jsxs("span", { children: ["DATE \u2665 ", formatDate(todo.createdAt)] })] }), _jsxs("div", { className: 'management-container', children: [_jsx("p", { children: "theme." }), _jsx(Toggle, { options: themes, selected: theme, onSelect: setTheme }), _jsx("p", { children: "your task." }), _jsx(TaskInput, { value: task, onChange: (e) => setTask(e.target.value) }), _jsx("p", { children: "importance." }), _jsx(Priority, { initial: priority, onChange: setPriority })] })] }), _jsx("div", { className: 'mg-bottom-box', children: _jsxs("div", { className: 'button-group', children: [_jsxs("div", { className: 'button-with-tooltip', children: [_jsx(Button, { label: '\uC218\uC815', onClick: handleUpdate, variant: 'primary', disabled: !isModified() }), _jsx("span", { className: 'edit-text', children: "* \uB0B4\uC6A9\uC744 \uC218\uC815\uD55C \uB4A4 \u2018\uC218\uC815\u2019 \uBC84\uD2BC\uC744 \uB204\uB974\uC138\uC694" })] }), _jsx(Button, { label: '\uBAA9\uB85D', onClick: handleCancel, variant: 'opaque' }), _jsx(Button, { label: '\uC0AD\uC81C', onClick: handleDelete, variant: 'delete' })] }) })] }));
}
