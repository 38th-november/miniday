      ...
      _jsxs('div', {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                className: 'history-header-text',
                children: [
                  _jsx('img', {
                    src: iconOpenedFolder,
                    alt: 'icon_opened_folder',
              ...
              _jsx('select', {
                ...
                children: themes.map((theme) =>
                  _jsx('option', { value: theme, children: theme }, theme),
                ),
              }),
            ],
          }),
                ...
                ? todoListActive.map((todo) =>
                    _jsxs(
                      'div',
                      {
                        ...
                        children: [
                          _jsx('p', { className: 'todo-theme', children: todo.theme }),
                          _jsx('div', {
                            onClick: () => navigate(`/management/${todo.id}`),
                            className: 'todo-clickable',
                            children: _jsx(TodoCard, {
                              task: todo.task,
